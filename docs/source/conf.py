...
try:
    from ezmsg.xdf.__version__ import version as release
except ImportError:
    release = "unknown"
...
html_baseurl = "https://www.ezmsg.org/ezmsg-xdf/"

html_theme_options = {
    "logo": {
        "text": f"ezmsg.xdf {version}",
    ...
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/ezmsg-org/ezmsg-xdf",
...
branch = "main"
code_url = f"https://github.com/ezmsg-org/ezmsg-xdf/blob/{branch}/"
